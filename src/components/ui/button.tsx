...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      primary:
        'bg-tenir-600 text-white hover:bg-tenir-700 active:bg-tenir-800 focus-visible:ring-tenir-500',
      secondary:
        'bg-accent-500 text-white hover:bg-accent-600 active:bg-accent-700 focus-visible:ring-accent-500',
      outline:
        'border-2 border-tenir-600 text-tenir-600 hover:bg-tenir-50 active:bg-tenir-100 focus-visible:ring-tenir-500',
      ghost:
        'text-tenir-600 hover:bg-tenir-50 active:bg-tenir-100 focus-visible:ring-tenir-500',
      danger:
